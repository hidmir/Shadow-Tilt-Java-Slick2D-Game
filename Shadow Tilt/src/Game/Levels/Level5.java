...
public class Level5 extends Levels
{
	...
	{
		levelEnd = new Rectangle(200+1, 325,24 ,24);
		image.draw(200+1, 325, 0.125f);
		g.setColor(Color.transparent);
		g.draw(levelEnd);
	}
	private static void drawWalls(Graphics g, Image walls)
	{	
		wall = new Rectangle[191];
		int tmp = 0;
		...
		g.draw(wall[tmp++] = drawWall(g, walls, 425, 100));
		g.draw(wall[tmp++] = drawWall(g, walls, 475, 100));
		g.draw(wall[tmp++] = drawWall(g, walls, 175, 125));
		g.draw(wall[tmp++] = drawWall(g, walls, 200, 125));
		for(int i = tmp, j = 0; tmp < i + 3; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 250 + j * 25, 125));
		g.draw(wall[tmp++] = drawWall(g, walls, 400, 125));
		g.draw(wall[tmp++] = drawWall(g, walls, 425, 125));
		for(int i = tmp, j = 0; tmp < i + 6; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 475 + j * 25, 125));
		for(int i = tmp, j = 0; tmp < i + 6; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 175 + j * 25, 175));
		g.draw(wall[tmp++] = drawWall(g, walls, 425, 175));
		for(int i = tmp, j = 0; tmp < i + 5; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 475 + j * 25, 175));
		g.draw(wall[tmp++] = drawWall(g, walls, 225, 200));
		g.draw(wall[tmp++] = drawWall(g, walls, 425, 200));
		...
		g.draw(wall[tmp++] = drawWall(g, walls, 475, 250));
		g.draw(wall[tmp++] = drawWall(g, walls, 225, 275));
		g.draw(wall[tmp++] = drawWall(g, walls, 425, 275));
		g.draw(wall[tmp++] = drawWall(g, walls, 475, 275));
		for(int i = tmp, j = 0; tmp < i + 3; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 175 + j * 25, 300));
		g.draw(wall[tmp++] = drawWall(g, walls, 425, 300));
		g.draw(wall[tmp++] = drawWall(g, walls, 475, 300));
		g.draw(wall[tmp++] = drawWall(g, walls, 175, 325));
		g.draw(wall[tmp++] = drawWall(g, walls, 425, 325));
		g.draw(wall[tmp++] = drawWall(g, walls, 475, 325));
		for(int i = tmp, j = 0; tmp < i + 11; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 175 + j * 25, 350));
		g.draw(wall[tmp++] = drawWall(g, walls, 475, 350));
		for(int i = tmp, j = 0; tmp < i + 5; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 175 + j * 25, 375));
		for(int i = tmp, j = 0; tmp < i + 5; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 325 + j * 25, 375));
		for(int i = tmp, j = 0; tmp < i + 6; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 475 + j * 25, 375));
		for(int i = tmp, j = 0; tmp < i + 5; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 500 + j * 25, 400));
		...
		for(int i = tmp, j = 0; tmp < i + 3; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 200 + j * 25, 450));
		g.draw(wall[tmp++] = drawWall(g, walls, 375, 450));
		...
		g.draw(wall[tmp++] = drawWall(g, walls, 375, 500));
		for(int i = tmp, j = 0; tmp < i + 5; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 500 + j * 25, 500));
	}
	private static void createEnemies1(Graphics g, Image image)
	{
		enemies1 = new Enemy1[7];
		enemies1[0] = new Enemy1(g, image, 375, 400, true);
		enemies1[1] = new Enemy1(g, image, 175, 150, true);
		enemies1[2] = new Enemy1(g, image, 250, 200, true);
		enemies1[3] = new Enemy1(g, image, 250, 225, true);
		enemies1[4] = new Enemy1(g, image, 250, 250, true);
		enemies1[5] = new Enemy1(g, image, 250, 275, true);
		enemies1[6] = new Enemy1(g, image, 250, 300, true);
	...
	private static void createEnemies2(Graphics g, Image image)
	{
		...
		enemies2[0] = new Enemy2(g, image, 450, 400, false);
		enemies2[1] = new Enemy2(g, image, 300, 500, true);
		enemies2[2] = new Enemy2(g, image, 500, 300, true);
		enemies2[3] = new Enemy2(g, image, 525, 325, true);
		enemies2[4] = new Enemy2(g, image, 550, 350, true);
	...
	private static void createMovableObjects(Graphics g, Image image)
	{
		...
		movableObjects[0] = new MovableObject(g, image, 250, 475);
		movableObjects[1] = new MovableObject(g, image, 475, 150);
		movableObjects[2] = new MovableObject(g, image, 375, 125);
		movableObjects[3] = new MovableObject(g, image, 350, 125);
		movableObjects[4] = new MovableObject(g, image, 325, 125);
