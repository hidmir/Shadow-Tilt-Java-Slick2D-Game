...
public class Level4 extends Levels
{
	...
	{
		player = new Player(g, image, 525, 425);
	...
	{
		levelEnd = new Rectangle(325+1, 125,24 ,24);
		image.draw(325+1, 125, 0.125f);
		g.setColor(Color.transparent);
		g.draw(levelEnd);
	}
	private static void drawWalls(Graphics g, Image walls)
	{	
		wall = new Rectangle[204];
		int tmp = 0;
		...
		for(int i = tmp, j = 0; tmp < i + 3; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 300 + j * 25, 100));
		g.draw(wall[tmp++] = drawWall(g, walls, 475, 75));
		g.draw(wall[tmp++] = drawWall(g, walls, 525, 75));
		for(int i = tmp, j = 0; tmp < i + 5; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 375 + j * 25, 100));
		...
		for(int i = tmp, j = 0; tmp < i + 4; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 525 + j * 25, 150));
		g.draw(wall[tmp++] = drawWall(g, walls, 325, 175));
		for(int i = tmp, j = 0; tmp < i + 7; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 325 + j * 25, 200));
		for(int i = tmp, j = 0; tmp < i + 4; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 525 + j * 25, 200));
		g.draw(wall[tmp++] = drawWall(g, walls, 325, 225));
		for(int i = tmp, j = 0; tmp < i + 3; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 200 + j * 25, 250));
		for(int i = tmp, j = 0; tmp < i + 7; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 325 + j * 25, 250));
		for(int i = tmp, j = 0; tmp < i + 4; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 525 + j * 25, 250));
		g.draw(wall[tmp++] = drawWall(g, walls, 200, 275));
		g.draw(wall[tmp++] = drawWall(g, walls, 250, 275));
		g.draw(wall[tmp++] = drawWall(g, walls, 325, 275));
		g.draw(wall[tmp++] = drawWall(g, walls, 200, 300));
		for(int i = tmp, j = 0; tmp < i + 10; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 250 + j * 25, 300));
		for(int i = tmp, j = 0; tmp < i + 4; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 525 + j * 25, 300));
		g.draw(wall[tmp++] = drawWall(g, walls, 200, 325));
		g.draw(wall[tmp++] = drawWall(g, walls, 575, 325));
		g.draw(wall[tmp++] = drawWall(g, walls, 200, 350));
		for(int i = tmp, j = 0; tmp < i + 14; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 250 + j * 25, 350));
		g.draw(wall[tmp++] = drawWall(g, walls, 200, 375));
		for(int i = tmp, j = 0; tmp < i + 14; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 250 + j * 25, 375));
		g.draw(wall[tmp++] = drawWall(g, walls, 200, 400));
		g.draw(wall[tmp++] = drawWall(g, walls, 475, 400));
		g.draw(wall[tmp++] = drawWall(g, walls, 575, 400));
		g.draw(wall[tmp++] = drawWall(g, walls, 200, 425));
		g.draw(wall[tmp++] = drawWall(g, walls, 575, 425));
		g.draw(wall[tmp++] = drawWall(g, walls, 200, 450));
		g.draw(wall[tmp++] = drawWall(g, walls, 475, 450));
		g.draw(wall[tmp++] = drawWall(g, walls, 575, 450));
		for(int i = tmp, j = 0; tmp < i + 16; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 200 + j * 25, 475));
	}
	private static void createEnemies1(Graphics g, Image image)
	{
		enemies1 = new Enemy1[4];
		enemies1[0] = new Enemy1(g, image, 550, 325, false);
		enemies1[1] = new Enemy1(g, image, 400, 275, true);
		enemies1[2] = new Enemy1(g, image, 400, 225, true);
		enemies1[3] = new Enemy1(g, image, 400, 175, true);
	...
	{
		movableObjects = new MovableObject[11];
		movableObjects[0] = new MovableObject(g, image, 425, 400);
		movableObjects[1] = new MovableObject(g, image, 425, 425);
		movableObjects[2] = new MovableObject(g, image, 425, 450);
		movableObjects[3] = new MovableObject(g, image, 350, 400);
		movableObjects[4] = new MovableObject(g, image, 350, 425);
		movableObjects[5] = new MovableObject(g, image, 350, 450);
		movableObjects[6] = new MovableObject(g, image, 275, 400);
		movableObjects[7] = new MovableObject(g, image, 275, 425);
		movableObjects[8] = new MovableObject(g, image, 275, 450);
		movableObjects[9] = new MovableObject(g, image, 300, 325);
		movableObjects[10] = new MovableObject(g, image, 500, 300);
