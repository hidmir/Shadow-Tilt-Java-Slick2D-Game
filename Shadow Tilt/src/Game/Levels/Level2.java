...
public class Level2 extends Levels
{
	...
	{
		player = new Player(g, image, 575, 275);
	...
	{
		levelEnd = new Rectangle(575+1, 175, 24, 24);
		image.draw(575+1, 175, 0.125f);
		g.setColor(Color.transparent);
		g.draw(levelEnd);
	}
	private static void drawWalls(Graphics g, Image walls)
	{	
		wall = new Rectangle[194];
		int tmp = 0;
		...
		for(int i = tmp, j = 0; tmp < i + 13; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 225 + j * 25, 100 ));
		g.draw(wall[tmp++] = drawWall(g, walls, 225, 125));
		for(int i = tmp, j = 0; tmp < i + 4; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 525 + j * 25, 125 ));
		for(int i = tmp, j = 0; tmp < i + 3; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 175 + j * 25, 150));
		...
		g.draw(wall[tmp++] = drawWall(g, walls, 475, 425));
		for(int i = tmp, j = 0; tmp < i + 3; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 475 + j * 25, 400 ));
		g.draw(wall[tmp++] = drawWall(g, walls, 525, 375));
		g.draw(wall[tmp++] = drawWall(g, walls, 525, 350));
		for(int i = tmp, j = 0; tmp < i + 5; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 275 , 350+ j *25));
		for(int i = tmp, j = 0; tmp < i + 5; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 325 , 350+ j *25));
		for(int i = tmp, j = 0; tmp < i + 5; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 375 , 350+ j *25));
	}
	...
	private static void createEnemies2(Graphics g, Image image)
	{
		...
		enemies2[0] = new Enemy2(g, image, 250, 350, false);
		enemies2[1] = new Enemy2(g, image, 300, 350, false);
		enemies2[2] = new Enemy2(g, image, 350, 350, false);
	...
	{
		enemies4 = new Enemy4[6];
		enemies4[0] = new Enemy4(g, image, 500, 425);
		enemies4[1] = new Enemy4(g, image, 325, 175);
		enemies4[2] = new Enemy4(g, image, 350, 200);
		enemies4[3] = new Enemy4(g, image, 375, 150);
		enemies4[4] = new Enemy4(g, image, 400, 225);
		enemies4[5] = new Enemy4(g, image, 425, 125);
