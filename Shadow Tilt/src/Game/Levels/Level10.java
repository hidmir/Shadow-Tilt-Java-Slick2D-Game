...
public class Level10 extends Levels
{
	...
	{
		player = new Player(g, image, 550, 450);
	...
	{
		levelEnd = new Rectangle(175+1, 100, 24, 24);
		image.draw(175+1, 100, 0.125f);
		g.setColor(Color.transparent);
		g.draw(levelEnd);
	}
	private static void drawWalls(Graphics g, Image walls)
	{	
		wall = new Rectangle[211-2-1];
		int tmp = 0;
		...
		for(int i = tmp, j = 0; tmp < i + 3; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 375 + j *25, 350));
		g.draw(wall[tmp++] = drawWall(g, walls, 375, 375));
		g.draw(wall[tmp++] = drawWall(g, walls, 425, 375));
		for(int i = tmp, j = 0; tmp < i + 3; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 500 + j *25, 375));
		...
		for(int i = tmp, j = 0; tmp < i + 4; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 425 + j *25, 400));
		for(int i = tmp, j = 0; tmp < i + 3; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 550 + j *25, 400));
		g.draw(wall[tmp++] = drawWall(g, walls, 600, 425));
		g.draw(wall[tmp++] = drawWall(g, walls, 175, 450));
		g.draw(wall[tmp++] = drawWall(g, walls, 600, 475));
		for(int i = tmp, j = 0; tmp < i + 5; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 175 + j *25, 500));
		for(int i = tmp, j = 0; tmp < i + 3; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 325 + j *25, 500));
		for(int i = tmp, j = 0; tmp < i + 8; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 425 + j *25, 500));
		//118
		for(int i = tmp, j = 0; tmp < i + 9; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 175 , 175 + j * 25));
		for(int i = tmp, j = 0; tmp < i + 5; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 225 , 275 + j * 25));
		for(int i = tmp, j = 0; tmp < i + 3; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 275 , 175 + j * 25));
		for(int i = tmp, j = 0; tmp < i + 2; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 225 + j *25, 175));
		g.draw(wall[tmp++] = drawWall(g, walls, 225, 225));
		g.draw(wall[tmp++] = drawWall(g, walls, 275, 200));
		g.draw(wall[tmp++] = drawWall(g, walls, 275, 225));
		g.draw(wall[tmp++] = drawWall(g, walls, 250, 275));
		g.draw(wall[tmp++] = drawWall(g, walls, 275, 275));
		g.draw(wall[tmp++] = drawWall(g, walls, 275, 250));
		//143
		...
		for(int i = tmp, j = 0; tmp < i + 2; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 300 + j *25, 75));
		for(int i = tmp, j = 0; tmp < i + 4; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 500 + j *25, 75));
		for(int i = tmp, j = 0; tmp < i + 2; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 550 + j *25, 125));
		for(int i = tmp, j = 0; tmp < i + 2; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 550 + j *25, 150));
		for(int i = tmp, j = 0; tmp < i + 2; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 550 + j *25, 200));
		for(int i = tmp, j = 0; tmp < i + 2; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 550 + j *25, 225));
		for(int i = tmp, j = 0; tmp < i + 2; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 550 + j *25, 275));
		for(int i = tmp, j = 0; tmp < i + 8; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 375 + j *25, 300));
		for(int i = tmp, j = 0; tmp < i + 4; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 300 + j *25, 275));
		for(int i = tmp, j = 0; tmp < i + 4; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 325 , 175 + j * 25));
		for(int i = tmp, j = 0; tmp < i + 4; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 375 , 175 + j * 25));
		for(int i = tmp, j = 0; tmp < i + 9; tmp++, j++)
			g.draw(wall[tmp] = drawWall(g, walls, 600 , 75 + j * 25));
		g.draw(wall[tmp++] = drawWall(g, walls, 450, 200));
		g.draw(wall[tmp++] = drawWall(g, walls, 475, 200));
		g.draw(wall[tmp++] = drawWall(g, walls, 450, 225));
		g.draw(wall[tmp++] = drawWall(g, walls, 475, 225));
		//211
	}
	private static void createEnemies1(Graphics g, Image image)
	{
		enemies1 = new Enemy1[5];
		enemies1[0] = new Enemy1(g, image, 175, 425, true);
		enemies1[1] = new Enemy1(g, image, 175, 475, true);
		enemies1[2] = new Enemy1(g, image, 575, 100, false);
		enemies1[3] = new Enemy1(g, image, 575, 175, false);
		enemies1[4] = new Enemy1(g, image, 575, 250, false);
	...
	private static void createEnemies2(Graphics g, Image image)
	{
		...
		enemies2[0] = new Enemy2(g, image, 400, 375, true);
		enemies2[1] = new Enemy2(g, image, 300, 250, true);
		enemies2[2] = new Enemy2(g, image, 350, 250, true);
	...
	private static void createEnemies5(Graphics g, Image image)
	{
		...
		enemies5[0] = new Enemy5(g, image, 600, 450);
		enemies5[1] = new Enemy5(g, image, 200, 100);
	...
	private static void createMovableObjects(Graphics g, Image image)
	{
		...
		movableObjects[0] = new MovableObject(g, image, 525, 425);
		movableObjects[1] = new MovableObject(g, image, 300, 475);
		movableObjects[2] = new MovableObject(g, image, 200, 225);
	...
	private static void createPressurePlate1(Graphics g, Image image)
	{
		...
		pressurePlate1[0] = new PressurePlate(g, image, 525, 400);
	...
	{
		unlockableWalls1 = new UnlockableWall[6];
		unlockableWalls1[0] = new UnlockableWall(g, image, 575, 425, false);
		unlockableWalls1[1] = new UnlockableWall(g, image, 575, 450, false);
		unlockableWalls1[2] = new UnlockableWall(g, image, 575, 475, false);
		unlockableWalls1[3] = new UnlockableWall(g, image, 500, 425, false);
		unlockableWalls1[4] = new UnlockableWall(g, image, 500, 450, false);
		unlockableWalls1[5] = new UnlockableWall(g, image, 500, 475, false);
	...
	private static void createPressurePlate2(Graphics g, Image image)
	{
		...
		pressurePlate2[0] = new PressurePlate(g, image, 200, 250);
	...
	{
		unlockableWalls2 = new UnlockableWall[1];
		unlockableWalls2[0] = new UnlockableWall(g, image, 200, 175, true);
	...
	private static void createPressurePlate3(Graphics g, Image image)
	{
		...
		pressurePlate3[0] = new PressurePlate(g, image, 300, 500);
	...
	{
		unlockableWalls3 = new UnlockableWall[1];
		unlockableWalls3[0] = new UnlockableWall(g, image, 200, 400, true);
